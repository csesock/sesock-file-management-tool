...
listfilesButton = ttk.Button(text='List Files', width=15, command=lambda:listFiles()).place(x=20, y=180)
...
def changeDirectory(event=None):
    ...
    filename = filedialog.askdirectory()[-50:]
    text.set(filename)
